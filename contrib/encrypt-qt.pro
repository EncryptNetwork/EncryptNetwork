...
RESOURCES += src/qt/encrypt.qrc src/qt/encrypt_locale.qrc

TRANSLATIONS += src/qt/locale/encrypt_bg.ts \
                src/qt/locale/encrypt_de.ts \
                src/qt/locale/encrypt_en.ts \
                src/qt/locale/encrypt_es.ts \
                src/qt/locale/encrypt_fi.ts \
                src/qt/locale/encrypt_fr.ts \
                src/qt/locale/encrypt_it.ts \
                src/qt/locale/encrypt_ja.ts \
                src/qt/locale/encrypt_pl.ts \
                src/qt/locale/encrypt_pt.ts \
                src/qt/locale/encrypt_ru.ts \
                src/qt/locale/encrypt_sk.ts \
                src/qt/locale/encrypt_sv.ts \
                src/qt/locale/encrypt_vi.ts \
                src/qt/locale/encrypt_zh_CN.ts \
                src/qt/locale/encrypt_zh_TW.ts
