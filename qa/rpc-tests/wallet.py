...
#   c) node1 mines 32 blocks, so now node 0 has 60001encrypt, node 1 has 4250encrypt, node2 has none.
#   d) node0 sends 601 encrypt to node2, in two transactions (301 encrypt, then 300 encrypt).
