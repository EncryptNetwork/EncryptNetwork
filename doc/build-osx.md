...
Once dependencies are compiled, see release-process.md for how the Encrypt-Qt.app
...
commands:
    ...
    echo -e "rpcuser=encryptrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Encrypt/encrypt.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Encrypt/encrypt.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/Encrypt/debug.log
