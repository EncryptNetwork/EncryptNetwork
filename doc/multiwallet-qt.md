...
In order to support loading of multiple wallets in encrypt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is encrypt.cpp.
...
Changes to encrypt.cpp
----------------------
encrypt.cpp is the entry point into encrypt-qt, and as such, will require some minor modifications to provide hooks for
