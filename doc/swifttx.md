...
This mechanism has been integrated into Bitcore-Node-XCX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EncryptCore-Project/insight-api-encrypt#web-socket-api](https://github.com/EncryptCore-Project/insight-api-encrypt#web-socket-api)
* API: [https://github.com/EncryptCore-Project/insight-api-encrypt#swifttx-transactions](https://github.com/EncryptCore-Project/insight-api-encrypt#swifttx-transactions)
...
By default, the XCX daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XCX daemon:
