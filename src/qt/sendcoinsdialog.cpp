...
// Copyright (c) 2015-2017 The XCX Project developers
...
void SendCoinsDialog::on_sendButton_clicked(){
    if (!masternodeSync.IsBlockchainSynced()) {
        ...
        msgBox.setText("Sending XCX is disabled when you are still syncing the wallet. Please allow the wallet to fully sync before attempting to send a transaction.");
