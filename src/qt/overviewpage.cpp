...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, QString& sXCXPercentage)
{
    int nPrecision = 2;

    double dPercentage = 100.0;
    
    sXCXPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
}
