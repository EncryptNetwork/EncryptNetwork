...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XCX"), this);
    aboutAction->setStatusTip(tr("Show information about XCX"));
    ...
    openAction->setStatusTip(tr("Open a XCX: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XCX client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("XCX"); // default title
