                                                                            ...
                                                                            m_fMousePress(0)
{
    ...
    QString windowTitle = tr("Encrypt") + " ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Encrypt"), this);
    aboutAction->setStatusTip(tr("Show information about Encrypt"));
    ...
    showDataDirAction = new QAction(QIcon(":/icons/browse"), tr("Show &EncryptCore Folder"), this);
    showDataDirAction->setStatusTip(tr("Show the EncryptCore folder"));
    ...
    openAction->setStatusTip(tr("Open a Encrypt: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain Explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    facebookAction = new QAction(QIcon(":/icons/facebook"), tr("Bitcointalk ANN"), this);
    facebookAction->setStatusTip(tr("Bitcointalk ANN"));
    twitterAction = new QAction(QIcon(":/icons/twitter"), tr("Twitter"), this);
    twitterAction->setStatusTip(tr("Encrypt Twitter"));
    discordAction = new QAction(QIcon(":/icons/discord"), tr("Discord"), this);
    discordAction->setStatusTip(tr("Encrypt Discord"));
    telegramOfficialAction = new QAction(QIcon(":/icons/telegram"), tr("Telegram - Main"), this);
    telegramOfficialAction->setStatusTip(tr("Encrypt Telegram - Main"));
    telegramLoungeAction = new QAction(QIcon(":/icons/telegram"), tr("Telegram - Lounge"), this);
    telegramLoungeAction->setStatusTip(tr("Encrypt Telegram - Lounge"));
    mediumAction = new QAction(QIcon(":/icons/medium"), tr("Medium"), this);
    mediumAction->setStatusTip(tr("Encrypt Medium"));
    steemitAction = new QAction(QIcon(":/icons/steemit"), tr("Steemit"), this);
    steemitAction->setStatusTip(tr("Encrypt Steemit"));
    instagramAction = new QAction(QIcon(":/icons/instagram"), tr("Instagram"), this);
    instagramAction->setStatusTip(tr("Encrypt Instagram"));
    redditAction = new QAction(QIcon(":/icons/reddit"), tr("Reddit"), this);
    redditAction->setStatusTip(tr("Encrypt Reddit"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line Options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Encrypt help message to get a list with possible Encrypt command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        QLabel* encryptico = new QLabel;
        encryptico->setPixmap(QIcon(":icons/bitcoin").pixmap(130, 107));
        encryptico->setObjectName("encryptico");

        navLayout->addWidget(encryptico);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Encrypt client") + " " + networkStyle->getTitleAddText();
...
{
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=5259296"));
}
void BitcoinGUI::twitterActionClicked()
{
    QDesktopServices::openUrl(QUrl("https://twitter.com/EncryptNetwork"));
}
void BitcoinGUI::discordActionClicked()
{
    QDesktopServices::openUrl(QUrl("https://discord.gg/pUfnF2"));
}
void BitcoinGUI::telegramOfficialActionClicked()
{
    //QDesktopServices::openUrl(QUrl("https://t.me/encrypt"));
}
void BitcoinGUI::telegramLoungeActionClicked()
{
   // QDesktopServices::openUrl(QUrl("https://t.me/ENCRYPT_LOUNGE"));
}
void BitcoinGUI::mediumActionClicked()
{
    //QDesktopServices::openUrl(QUrl("https://medium.com/EncryptCore"));
}
void BitcoinGUI::instagramActionClicked()
{
    //QDesktopServices::openUrl(QUrl("https://www.instagram.com/EncryptCore/"));
}
void BitcoinGUI::redditActionClicked()
{
   // QDesktopServices::openUrl(QUrl("https://www.reddit.com/r/EncryptCore/"));
}
void BitcoinGUI::steemitActionClicked()
{
    //QDesktopServices::openUrl(QUrl("https://steemit.com/@EncryptCore/"));
}
...
{
    QDesktopServices::openUrl(QUrl("https://officialencrypt.com/faq"));
}

void BitcoinGUI::openBlockExplorerAPIClicked()
{
    QDesktopServices::openUrl(QUrl("https://explorer.encrypt.com/api/getblockcount"));
}

void BitcoinGUI::openBootStrapClicked()
{
    QDesktopServices::openUrl(QUrl("https://github.com/EncryptCore/BootStrap/releases/tag/latest"));
}

void BitcoinGUI::openTGTechSupportClicked()
{
    QDesktopServices::openUrl(QUrl("https://t.me/ENCRYPTTechSupport"));
}

void BitcoinGUI::openTGMNSupportClicked()
{
    QDesktopServices::openUrl(QUrl("https://t.me/ENCRYPT_MN_Support"));
}
...
{
    QUrl serviceUrl = QUrl("https://raw.githubusercontent.com/EncryptCore/EncryptCore/master/version.txt");
    ...
    if(reply->error() == QNetworkReply::NoError) {
        ...
        if (data.trimmed() != currentVersion) {
            ...
            if (msgReply == QMessageBox::Yes) {
                QDesktopServices::openUrl(QUrl("https://github.com/EncryptCore/EncryptCore/releases/latest"));
            } else {
                return;
            }
        } else {
...
{
    QString strTitle = tr("Encrypt"); // default title
