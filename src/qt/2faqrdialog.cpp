...
#include "config/encrypt-config.h" /* for USE_QRCODE */
#endif
...
void TwoFAQRDialog::update()
{
    ...
    uri.sprintf("otpauth://totp/XCX:QT%20Wallet?secret=%s&issuer=encrypt&algorithm=SHA1&digits=6&period=30", addr.c_str());
