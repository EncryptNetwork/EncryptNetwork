...
/* Encryptcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XCX"
#define QAPP_ORG_DOMAIN "officialencrypt.com"
#define QAPP_APP_NAME_DEFAULT "EncryptCore-Qt"
#define QAPP_APP_NAME_TESTNET "EncryptCore-Qt-testnet"
