...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Encrypt Keychain Wallet");
    fLiteMode = GetBoolArg("-litemode", false);
    if (fLiteMode) {
        titleText = tr("Encrypt Lite Mode Wallet");
    }
    ...
    QString copyrightTextENCRYPT = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The XCX Project developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextENCRYPT);
