...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("XCX Coin Keychain Wallet");
    fLiteMode = GetBoolArg("-litemode", false);
    if (fLiteMode) {
        titleText = tr("XCX Coin Lite Mode Wallet");
    }
    ...
    QString copyrightTextXCX = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The XCX Project developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextXCX);
