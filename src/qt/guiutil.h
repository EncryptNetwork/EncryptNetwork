...
/** Utility functions used by the XCX Qt UI.
 */
namespace GUIUtil
{
...
// Render XCX addresses in monospace font
...
// Parse "encrypt:" URI into recipient object, return true on successful parsing
