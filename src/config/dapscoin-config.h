/* src/config/encrypt-config.h.  Generated from encrypt-config.h.in by configure.  */
/* src/config/encrypt-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ENCRYPT_CONFIG_H

#define ENCRYPT_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/EncryptCore/EncryptCore/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EncryptCore"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EncryptCore 1.0.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "encrypt"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://officialencrypt.com"
