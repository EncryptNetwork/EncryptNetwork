...
public:
    ...
    /** Used if GenerateEncrypts is called with a negative number of threads */
    ...
    int nLastPOWBlock;
    int TEAM_REWARD_FREQUENCY = 1; //every  TEAM_REWARD_FREQUENCY PoA blocks, reward the XCX team
    double MAX_MONEY;
    CAmount TOTAL_SUPPLY = 10000000000*COIN; 
