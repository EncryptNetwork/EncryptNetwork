 ...
 * XCX system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if GenerateEncryptcoins is called with a negative number of threads */
    ...
    int nLastPOWBlock;
    int TEAM_REWARD_FREQUENCY = 3; //every  TEAM_REWARD_FREQUENCY PoA blocks, reward the encrypt team
    double MAX_MONEY;
    CAmount TOTAL_SUPPLY = 10000000000*COIN; //10B XCX
