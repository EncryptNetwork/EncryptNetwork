...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XCX encrypt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  encrypt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded encrypt transaction") + "\n" +
                               "  encrypt-tx [options] -create [commands]   " + _("Create hex-encoded encrypt transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded encrypt transaction
