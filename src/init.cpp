...
void PrepareShutdown()
{
    ...
    if (pwalletMain)
        bitdb.Flush(false);
    GenerateEncryptcoins(false, NULL, 0);
#endif
    StopNode();
    DumpMasternodes();
    DumpBudgets();
...
// ********************************************************* Step 8: load wallet
    ...
    /* Denominations
       ...
       For example:
       1XCX+1000 == (.1XCX+100)*10
       10XCX+10000 == (1XCX+1000)*10
    */
    ...
    if (pwalletMain)
        GenerateEncryptcoins(GetBoolArg("-gen", false), pwalletMain, GetArg("-genproclimit", 1));
#endif
