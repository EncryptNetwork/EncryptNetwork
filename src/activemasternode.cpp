...
//
// Bootup the Masternode, look for a 1000000 XCX input and register on the network
//
...
vector<COutput> CActiveMasternode::SelectCoinsMasternode()
{
    ...
    {
        LOCK2(cs_main, pwalletMain->cs_wallet);
        pwalletMain->AvailableCoins(vCoins, true, NULL, false, AvailableCoinsType::ONLY_500000);
        ...
        for (const COutput& out : vCoins) {
            if (pwalletMain->getCTxOutValue(*out.tx, out.tx->vout[out.i]) == 500000 * COIN) { //exactly
