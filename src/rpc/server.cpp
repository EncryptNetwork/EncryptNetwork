...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Encryptcoin features */
         {"encrypt", "masternode", &masternode, true, true, false},
         {"encrypt", "listmasternodes", &listmasternodes, true, true, false},
         {"encrypt", "getmasternodecount", &getmasternodecount, true, true, false},
         {"encrypt", "getcurrentseesawreward", &getcurrentseesawreward, true, true, false},
         {"encrypt", "getseesawrewardratio", &getseesawrewardratio, true, true, false},
         {"encrypt", "getseesawrewardwithheight", &getseesawrewardwithheight, true, true, false},
         {"encrypt", "masternodeconnect", &masternodeconnect, true, true, false},
         {"encrypt", "masternodecurrent", &masternodecurrent, true, true, false},
         {"encrypt", "masternodedebug", &masternodedebug, true, true, false},
         {"encrypt", "startmasternode", &startmasternode, true, true, false},
         {"encrypt", "listmasternodeconf", &listmasternodeconf, true, true, false},
         {"encrypt", "getmasternodewinners", &getmasternodewinners, true, true, false},
         {"encrypt", "getmasternodescores", &getmasternodescores, true, true, false},
         {"encrypt", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
         {"encrypt", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
         {"encrypt", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
         {"encrypt", "mnsync", &mnsync, true, true, false},
         {"encrypt", "getpoolinfo", &getpoolinfo, true, true, false},
...
std::string HelpExampleCli(string methodname, string args) {
    return "> encrypt-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args) {
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2121/\n";
}
