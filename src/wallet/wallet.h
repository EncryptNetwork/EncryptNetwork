...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOT1000000IFMN = 4, // ONLY_NONDENOMINATED and not 1000000 XCX at the same time
...
public:
    static const CAmount MINIMUM_STAKE_AMOUNT = 100 * COIN;
    ...
    /// Get 1000000 XCX output and keys which can be used for the Masternode
